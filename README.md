...
![Схема подключения](/СхемаЛампа.png)
...
- **Энкодер** CLK - **D2**, DT - **D3**, SW - **D4**, + и - как обычно.
...
7. Если за одну минуту было больше 5 движений то светодиод будет 5 чек моргать красным.
8. Если с  KY-037(D5) придёт 1, то лампа включится на 30 сек.
